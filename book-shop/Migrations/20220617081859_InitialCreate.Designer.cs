...
namespace book_shop.Migrations
{
    ...
    [Migration("20220617081859_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("book_shop.Data.Entities.StoreUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("book_shop.Data.Entities.StoreUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("book_shop.Data.Entities.Order", b =>
                {
                    b.HasOne("book_shop.Data.Entities.StoreUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
